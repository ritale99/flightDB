	...
	<%
		...
		try {
			...
			//Get the combobox from the HelloWorld.jsp
				...
				//Match by flightID
				String str0 = "SELECT FlightDate.flight_id, flights.fare_first, flights.flight_type " + "FROM flights, FlightDate " + "WHERE flights.flight_num = FlightDate.flight_id AND flights.depart_aid = '" + departing_port + "';";
