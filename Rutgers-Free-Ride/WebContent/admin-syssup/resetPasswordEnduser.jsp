...
<title>Reset password for an end-user</title>
</head>
<body>
<link rel="stylesheet" type="text/css" href="../css/login.css">
	...
	out.print("<p>resetting password for account: "+newEmail+"</p>");
	...
	try {
		...
		if(!result.next()){
		    ...
		    String updateStr = "UPDATE end_user SET password='"+ newPswd +"' WHERE ru_email='" + newEmail + "'";
			...
			%>
			<script> 
			    alert("The account: " + newEmail + "'s password has been changed!");
		    	window.location.href = "systemSupport.jsp";
			</script>
			<p class="message">The account has been successfully changed password! <a href="systemSupport.jsp">Go Back</a></p>
